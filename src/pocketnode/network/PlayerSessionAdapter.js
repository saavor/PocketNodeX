...
const ResourcePackChunkDataPacket = require("../network/minecraft/protocol/ResourcePackChunkDataPacket");
const RequestChunkRadiusPacket = require("../network/minecraft/protocol/RequestChunkRadiusPacket");
