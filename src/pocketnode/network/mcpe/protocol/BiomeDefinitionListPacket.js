...
class BiomeDefinitionListPacket extends DataPacket {
    ...
    _encodePayload() {
        ...
        this.append(this.namedtag === null || new Buffer(BiomeDefinitionListPacket.HARDCODED_NBT_BLOB(), 'base64').toString('ascii'));
    }
