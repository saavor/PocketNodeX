...
class BiomeDefinitionListPacket extends DataPacket {
    ...
    _decodePayload() {
        console.log("BiomeDefinitionList called!");

        this.namedtag = this.readRemaining();
    }

    _encodePayload() {
        this.append(this.namedtag || BiomeDefinitionListPacket.HARDCODED_NBT_BLOB);
    }
